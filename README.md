...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dxfgrabber-feedstock/blob/master/LICENSE.txt)

Summary: A Python library to grab information from DXF drawings - all DXF versions supported.

Development: https://github.com/mozman/dxfgrabber

Documentation: http://dxfgrabber.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4741&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dxfgrabber-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
